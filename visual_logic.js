...
setHTMLElemAttribute('href', 'https://gaury.com', 'info_button', false);
...
operateAnimation('PLAY', 'gaury_armature', 0, 180, 'LoopRepeat', 1,
        function() {}, false);

    volume(loadMedia_WebAudio('sounds/hello.mp3'), 0.5);
registerOnClick('gaury_mesh', false, false, [0,1,2], function() {

  operateAnimation('STOP', 'gaury_armature', null, null, 'AUTO', 1,
          function() {}, false);

      playSound(loadMedia_WebAudio('sounds/hello.mp3'), false);

  operateAnimation('PLAY', 'gaury_armature', 181, 275, 'LoopOnce', 1,
          function() {
...
checkARMode(function() {
  eventHTMLElem('pointerup', 'enter_AR_button', false, function(event) {
    enterARMode('ORIGIN', true, function() {
      changeVis(['GROUP', 'gaury_group'], false);
      ...
      changeVis(['GROUP', 'gaury_group'], true);
      changeVis('prompt_move_around', false);
      setObjTransform('gaury_armature', false, 'position', createVector(0, 0, 0), false);
      ...
      setObjTransform('gaury_armature', false, 'scale', [1, 1, 1], false);
  ...
  setHTMLElemAttribute('href', exportToUSDZ('gaury_mesh'), 'enter_AR_button', false);
  setHTMLElemAttribute('rel', 'ar', 'enter_AR_button', false);
  setHTMLElemAttribute('download', 'gaury.usdz', 'enter_AR_button', false);
}, function() {
  eventHTMLElem('pointerup', 'enter_AR_button', false, function(event) {
...
registerOnClick('indicator_invis_plane', false, false, [0,1,2], function() {
  changeVis(['GROUP', 'gaury_group'], true);
  setObjTransform('gaury_armature', false, 'position', [arHitPoint('x'), arHitPoint('y'), arHitPoint('z')], false);
  setObjDirection('gaury_armature', getObjTransform('Camera', false, 'position', 'xyz'), true, true);
...
registerOnDrag('drag_move', false, [0,1,2], function() {}, function() {
  dragMoveAdv('gaury_armature', 'XY', 'WORLD', 'y:7ZuIaF%:()HA_eeK!_', '69DHSV6XkH`%yS]dSyB2');
}, function() {}, '69DHSV6XkH`%yS]dSyB2');

registerOnDrag('drag_rotate', false, [0,1,2], function() {}, function() {
  dragRotateAdv('gaury_armature', 'Z', 'WORLD', '9K]]%}7cw;/f`BRm_:Aa', 'q[e/mQQ@:wVIPD||L4va');
}, function() {}, 'q[e/mQQ@:wVIPD||L4va');

registerOnDrag('drag_scale', false, [0,1,2], function() {}, function() {
  dragScale('gaury_armature', 'Z', '?X+6Ov0N6CmD0%z82OTr', 'bCQ|qHLjctoRK,Wmt]k8');
  dragScale('gaury_armature', 'X', '4k?aJV,PwC3}l3]vna~`', 'bCQ|qHLjctoRK,Wmt]k8');
  dragScale('gaury_armature', 'Y', 'I_;YCD%sk~ASpD$?E7V:', 'bCQ|qHLjctoRK,Wmt]k8');
  updateTextObj('scale_percentage', String(Math.round(toFixedPoint(getObjTransform('gaury_armature', false, 'scale', 'z'), 2) * 100)) + '%');
}, function() {}, 'bCQ|qHLjctoRK,Wmt]k8');
